<template>
  <div class="meta-data-content page-css list-css" v-loading="pageLoading">
    ...
    <div class="functions-row">
      <el-button type="primary" @click="newEvent">新建安全组</el-button>
    </div>
    ...
    >
      <div>
        ...
        >
          ...
          <el-form-item label="安全组名称" prop="securityGroupName">
            <el-input v-model="dataForm.securityGroupName" placeholder="请输入安全组名称" maxlength="100" clearable show-word-limit/>
          </el-form-item>
          <el-form-item label="安全组" prop="resourceId">
            <RemoteSelect v-model="dataForm.resourceId" placeholder="请选择安全组"
                          optionsApi="/admin/api/azure/metas/getNSGSkuList"
                          :filterable="true" :optionsDefaultArgs="securityArgs"
    ...
    options: [
      {
        ...
        props: {placeholder: "请输入安全组名称", clearable: true},
      },
      {
        type: "el-input",
        label: "安全组ID",
        key: "resourceId",
        props: {placeholder: "请输入安全组ID", clearable: true},
      },
    ]
  },
]);
...
const formRules = {
  ...
  resourceId: FormCheck.required("请选择安全组"),
  securityGroupName: FormCheck.required("请输入安全组名称"),
};
...
const newEvent = () => {
  ...
  dataForm.resourceId = ''
  dataForm.name = ''
  dataForm.securityGroupName = ''

  securityArgs.value = {region: dataForm.region}
...
const editMateData = (item) => {
  ...
  dataForm.securityGroupName = item.securityGroupName
