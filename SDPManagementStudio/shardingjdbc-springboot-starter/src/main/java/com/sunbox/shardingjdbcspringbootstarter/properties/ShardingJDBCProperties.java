package com.sunbox.shardingjdbcspringbootstarter.properties;
...
public class ShardingJDBCProperties {
    ...
    public String getShowsql() {
        if (StringUtils.isEmpty(showsql)||showsql.equalsIgnoreCase("false")){
            return "false";
        }
        return "true";
    }
    ...
    private String multconfig;

    public String getMultconfig() {
        return multconfig;
    }

    public void setMultconfig(String multconfig) {
        this.multconfig = multconfig;
    }
