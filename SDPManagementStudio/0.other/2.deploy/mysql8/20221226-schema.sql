...
/*Table structure for table `ambari_component_layout` */
...
CREATE TABLE `ambari_component_layout` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=933 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Ambari组件部署布局';
...
) ENGINE=InnoDB AUTO_INCREMENT=3452 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Ambari默认配置项';
...
CREATE TABLE `ambari_config_item_attr` (
  ...
  KEY `idx_service_component_config_type` (`service_code`,`component_code`),
  KEY `idx_config_type_code` (`config_type_code`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Ambari配置项属性，默认在Stack中的配置';
...
CREATE TABLE `ambari_config_type` (
  ...
  `updated_time` datetime DEFAULT NULL COMMENT '更新时间;更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Ambari配置类型';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='集群操作计划模版;-';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='集群操作计划活动明细模版';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='集群预置脚本列表';
...
CREATE TABLE `base_dictionary` (
  ...
  PRIMARY KEY (`dict_id`)
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='字典表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='发行版包含应用组件';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='发行版本可用应用组件配置列表; sum(各个应用配置项数量）< 200';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='集群发行版本';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='发行版本使用操作系统; sum(各个应用配置项数量）< 200';
...
CREATE TABLE `base_scene` (
  ...
  `cluster_release_ver` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '集群版本号',
  `scene_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '场景名称',
  `scene_desc` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '场景描述',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `base_scene_apps` (
  `scene_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '场景ID',
  `app_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '组件名称',
  `app_version` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '组件版本号',
...
CREATE TABLE `base_script` (
  `script_id` varchar(40) COLLATE utf8mb4_general_ci NOT NULL COMMENT '脚本ID（UUID）',
  `script_name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '脚本名',
  `blob_path` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '脚本在blob上的存储路径',
  `upload_time` datetime DEFAULT NULL COMMENT '脚本上传时间',
  `remark` varchar(1024) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '脚本备注',
  `state` varchar(32) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'VALID' COMMENT '脚本状态;VALID，INVALID，DELETED',
...
CREATE TABLE `base_user_info` (
  ...
  `user_name` varchar(60) COLLATE utf8mb4_general_ci NOT NULL COMMENT '账号',
  `real_name` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '用户姓名',
  `dept_id` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '部门ID',
  `dept_name` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '部门名称',
  `password` varchar(60) COLLATE utf8mb4_general_ci NOT NULL COMMENT '密码',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `createdby` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '创建人',
  `modified_time` datetime DEFAULT NULL COMMENT '修改时间',
  `modifiedby` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`user_id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='集群配置; 1';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='集群部署应用; 1*集群要部署应用数量';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='集群应用组件配置; sum(各个应用配置项数量）< 200';
...
CREATE TABLE `conf_cluster_script` (
  ...
  `script_param` varchar(300) DEFAULT NULL COMMENT '脚本参数',
  `sort_no` int DEFAULT NULL COMMENT '排序',
  `createdby` varchar(60) DEFAULT NULL COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `node_list` text COMMENT '执行脚本的机器列表'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='集群可执行脚本列表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='集群标签表; 1*标签数量';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='集群实例组模式节点配置; 1000';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='集群实例数据盘配置; 1000';
...
CREATE TABLE `conf_keypair` (
  ...
  `createdby` varchar(60) DEFAULT NULL COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='密钥配置; <=1';
...
CREATE TABLE `config_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4184 DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE `info_cluster` (
  ...
  PRIMARY KEY (`cluster_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='集群创建信息; 1';
...
CREATE TABLE `info_cluster_operation_plan` (
  ...
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`plan_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='集群操作计划; 1';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='集群操作计划活动明细';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='playbook任务信息';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='集群实例创建信息; 1000';
...
CREATE TABLE `info_cluster_vm_job` (
  ...
  `end_time` datetime DEFAULT NULL COMMENT '任务结束时间',
  PRIMARY KEY (`transaction_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作虚拟机任务信息';
...
CREATE TABLE `stack_service_component` (
  ...
  `updated_time` datetime DEFAULT NULL COMMENT '更新时间;更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Stack布署的大数据组件';
