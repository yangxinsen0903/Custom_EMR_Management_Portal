CREATE DATABASE  IF NOT EXISTS `sdpms` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `sdpms`;
-- MySQL dump 10.13  Distrib 8.0.31, for macos12 (x86_64)
--
-- Host: sunboxdev.mysql.database.azure.com    Database: sdpms
-- ------------------------------------------------------
...
CREATE TABLE `ambari_component_layout` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=915 DEFAULT CHARSET=utf8mb4 COMMENT='Ambari组件部署布局';
...
CREATE TABLE `ambari_config_item` (
  ...
  `is_content_prop` tinyint(4) NOT NULL COMMENT '是否是内容字段',
  `is_dynamic` tinyint(4) NOT NULL COMMENT '是否动态计算的配置字段',
...
) ENGINE=InnoDB AUTO_INCREMENT=3432 DEFAULT CHARSET=utf8mb4 COMMENT='Ambari默认配置项';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ambari_config_item_attr` (
  ...
  KEY `idx_service_component_config_type` (`service_code`,`component_code`),
  KEY `idx_config_type_code` (`config_type_code`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COMMENT='Ambari配置项属性，默认在Stack中的配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ambari_config_type` (
  ...
  `is_file_content` tinyint(4) NOT NULL COMMENT '是否是配置文件内容;1:是  0：不是',
  ...
  `updated_time` datetime DEFAULT NULL COMMENT '更新时间;更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Ambari配置类型';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `base_cluster_operation_template` (
  ...
  `is_delete` int(11) DEFAULT NULL COMMENT '是否删除;0 无效 1 有效',
  `createdby` varchar(60) DEFAULT NULL COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`template_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='集群操作计划模版;-';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `base_cluster_operation_template_activity` (
  ...
  `sort_no` int(11) DEFAULT NULL COMMENT '执行顺序;按升序排序',
  `timeout` int(11) DEFAULT NULL COMMENT '超时时间（秒）',
  `createdby` varchar(60) DEFAULT NULL COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`activity_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='集群操作计划活动明细模版';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `base_cluster_script` (
  ...
  `sort_no` int(11) DEFAULT NULL COMMENT '脚本执行顺序;升序',
  `createdby` varchar(60) DEFAULT NULL COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`conf_script_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='集群预置脚本列表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `base_dictionary` (
  ...
  PRIMARY KEY (`dict_id`)
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8mb4 COMMENT='字典表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `base_release_apps` (
  ...
  `required` int(1) DEFAULT NULL COMMENT '是否必选',
  `sort_no` int(8) DEFAULT NULL COMMENT '显示排序',
  `created_by` varchar(60) DEFAULT NULL COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`release_version`,`app_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='发行版包含应用组件';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='发行版本可用应用组件配置列表; sum(各个应用配置项数量）< 200';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='集群发行版本';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='发行版本使用操作系统; sum(各个应用配置项数量）< 200';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `conf_cluster` (
  ...
  `is_ha` int(1) DEFAULT NULL COMMENT '是否高可用',
  `state` int(11) DEFAULT NULL COMMENT '状态;0 待创建 1 创建中 2 已创建  -1释放中 -2 已释放',
  `createdby` varchar(60) DEFAULT NULL COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `modifiedby` varchar(60) DEFAULT NULL COMMENT '修改人',
  `modified_time` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`cluster_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='集群配置; 1';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='集群部署应用; 1*集群要部署应用数量';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='集群应用组件配置; sum(各个应用配置项数量）< 200';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `conf_cluster_script` (
  ...
  `createdby` varchar(60) DEFAULT NULL COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='集群可执行脚本列表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='集群标签表; 1*标签数量';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `conf_cluster_vm` (
  ...
  `os_image_type` varchar(20) DEFAULT NULL COMMENT '镜像类型;标准/自定义',
  `os_version` varchar(60) DEFAULT NULL COMMENT '镜像内系统版本号',
  `os_volume_size` int(11) DEFAULT NULL COMMENT 'OS磁盘大小',
  ...
  `count` int(11) DEFAULT NULL COMMENT '实例购买数量',
  `purchase_type` int(11) DEFAULT NULL COMMENT '购买类型;1 按需  2 竞价',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='集群实例组模式节点配置; 1000';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `conf_cluster_vm_data_volume` (
  ...
  `data_volume_size` int(11) DEFAULT NULL COMMENT '数据盘大小（GB）',
  `count` int(11) DEFAULT NULL COMMENT '购买磁盘数量',
  PRIMARY KEY (`volume_conf_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='集群实例数据盘配置; 1000';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `conf_keypair` (
  ...
  `createdby` varchar(60) DEFAULT NULL COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='密钥配置; <=1';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `info_cluster` (
  ...
  `ambari_count` int(11) DEFAULT NULL COMMENT 'ambari实例数量',
  `master_vms_count` int(11) DEFAULT NULL COMMENT 'master实例数量',
  `core_vms_count` int(11) DEFAULT NULL COMMENT 'core实例数量',
  `task_vms_count` int(11) DEFAULT NULL COMMENT 'task实例数量',
  `apps_count` int(11) DEFAULT NULL COMMENT '组件应用数量',
  ...
  PRIMARY KEY (`cluster_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='集群创建信息; 1';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `info_cluster_operation_plan` (
  ...
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`plan_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='集群操作计划; 1';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `info_cluster_operation_plan_activity_log` (
  ...
  `state` int(11) DEFAULT NULL COMMENT '执行状态;0 未执行 1 执行中 2 执行完成  -1 执行超时  -2 执行失败',
  `createdby` varchar(60) DEFAULT NULL COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`activity_log_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='集群操作计划活动明细';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `info_cluster_playbook_job` (
  ...
  `job_status` int(11) DEFAULT NULL COMMENT '任务状态;0 job创建完成 1 执行中 2 执行完成 3 job行失败',
  `beg_time` datetime DEFAULT NULL COMMENT '任务开始时间',
  `end_time` datetime DEFAULT NULL COMMENT '任务结束时间',
  PRIMARY KEY (`transaction_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='playbook任务信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `info_cluster_vm` (
  ...
  `vm_conf_id` varchar(40) DEFAULT NULL COMMENT '实例配置ID',
  `host_name` varchar(60) DEFAULT NULL COMMENT '机器名称',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='集群实例创建信息; 1000';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `info_cluster_vm_job` (
  ...
  `end_time` datetime DEFAULT NULL COMMENT '任务结束时间',
  PRIMARY KEY (`transaction_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='操作虚拟机任务信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stack` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键;自增主键',
  `name` varchar(64) NOT NULL COMMENT 'Stack名;如SDP',
  `version` varchar(16) NOT NULL COMMENT 'Stack版本;如：3.1.1',
  `created_by` varchar(32) DEFAULT NULL COMMENT '创建人;创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间;创建时间',
  `updated_by` varchar(32) DEFAULT NULL COMMENT '更新人;更新人',
  `updated_time` datetime DEFAULT NULL COMMENT '更新时间;更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='Stack';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `stack_service`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `stack_service` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键;自增主键',
  `stack_id` bigint(20) NOT NULL COMMENT 'Stack主键',
  `code` varchar(32) NOT NULL COMMENT '服务代码;如HADOOP',
  `name` varchar(64) NOT NULL COMMENT '服务名;如Hadoop',
  `version` varchar(255) NOT NULL COMMENT '服务版本',
  `mapping_code` varchar(32) NOT NULL COMMENT '映射的外部系统服务代码;如：HIVE',
  `created_by` varchar(32) DEFAULT NULL COMMENT '创建人;创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间;创建时间',
  `updated_by` varchar(32) DEFAULT NULL COMMENT '更新人;更新人',
  `updated_time` datetime DEFAULT NULL COMMENT '更新时间;更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='Stack包含大数据服务表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stack_service_component` (
  ...
  `is_client` tinyint(4) DEFAULT '0' COMMENT '是否是客户端;1：客户端组件 0：服务端组件',
  `created_by` varchar(32) DEFAULT NULL COMMENT '创建人;创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间;创建时间',
  `updated_by` varchar(32) DEFAULT NULL COMMENT '更新人;更新人',
  `updated_time` datetime DEFAULT NULL COMMENT '更新时间;更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Stack布署的大数据组件';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-12-15  3:09:16
