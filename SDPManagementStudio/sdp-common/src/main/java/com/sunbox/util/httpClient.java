...
public class httpClient {
    ...
    public static String doPostWithFile(String url, File file) {
        return doPostWithFile(url, file, null);
    }
    /**
     *
     * post with multipart file,file name in url
     * */
    public static String doPostWithFile(String url, File file, Map<String, String> header) {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        String respStr = "";
        try {
            HttpPost httpPost = new HttpPost(url);
