...
public class HttpClientUtil {
    ...
    public static String doGet(String url, Map<String, String> param) {
        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                logger.info("do get execute error {}, httpstatuscode {}",url,response.getStatusLine().getStatusCode());
            }
        } catch (Exception e) {
    ...
    public static String doGetWithRequestTimeOut(String url, Map<String, String> param,Integer timeout) throws Exception {
    ...
    public static String doPost(String url, String json) {
        ...
        try {
            ...
            Long end = System.currentTimeMillis();
            logger.info("外部接口请求耗时统计,url:{},耗时：{}ms",url,end-beg);
            logger.info("请求状态码："+response.getStatusLine().getStatusCode());
            resultString = EntityUtils.toString(response.getEntity(), "UTF-8");
            logger.info("do post execute {} response {}", url, resultString);
        } catch (Exception e) {
    ...
    public static String doPut(String url, String json) {
        ...
        try {
            ...
            Long end = System.currentTimeMillis();
            logger.info("外部接口请求耗时统计,url:{},耗时：{}ms",url,end-beg);
            logger.info("respose statuscode："+response.getStatusLine().getStatusCode());
            resultString = EntityUtils.toString(response.getEntity(), "UTF-8");
            logger.info("do put execute: {}, response: {}", url, resultString);
        } catch (Exception e) {
    ...
    public static HttpResult httpPut(String url, String json) {
        // 创建Httpclient对象
        CloseableHttpClient httpClient = HttpClients.createDefault();
        CloseableHttpResponse response = null;
        String resultString = "";
     ...
     * @return
     */
    public static HttpResult httpPutWithRequestTimeOut(String url, String json,Integer timeout) {
    ...
    public static ResultMsg doPutWithResultMsg(String url, String json) {
        // 创建Httpclient对象
        CloseableHttpClient httpClient = HttpClients.createDefault();
        CloseableHttpResponse response = null;
        ...
        try {
            ...
            response = httpClient.execute(httpPut);
            resultString = EntityUtils.toString(response.getEntity(), "UTF-8");
            resultMsg.setRetcode(response.getStatusLine().getStatusCode()+"");
            resultMsg.setData(resultString);
            logger.info("do put execute: {}, response: {}", url, resultMsg);
        } catch (Exception e) {
            logger.error("do put execute: {}, exception: {}", url, e);
        } finally {
            try {
     ...
     * */
    public static String doPostWithMultipartFile(String url, MultipartFile file) {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        String respStr = "";
        try {
            HttpPost httpPost = new HttpPost(url);
    ...
    public static String doDeleteWithRequestTimeOut(String url,Integer timeOut) throws Exception {
        RequestConfig requestConfig = RequestConfig.custom()
                .setSocketTimeout(timeOut * 1000)
                .setConnectTimeout(5000)
                .build();
