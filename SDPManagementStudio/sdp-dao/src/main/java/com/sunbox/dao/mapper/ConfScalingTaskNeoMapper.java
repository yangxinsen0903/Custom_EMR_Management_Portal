...
@Mapper
@Repository
public interface ConfScalingTaskNeoMapper {
    ...
    List<ConfScalingTask> selectByParams(Map<String, Object> params);

    List<ConfScalingTask> selectByParamsOrderByBeginTimeDesc(Map<String, Object> params);

    List<ConfScalingTask> selectByParamsOrderByCreateTimeAsc(Map<String, Object> params);

    List<ConfScalingTask> selectByParamsOrderByEndTimeAsc(Map<String, Object> params);

    List<ConfScalingTask> selectRunningOrInqueueTasksByClusterAndGroupName(@Param("clusterId") String clusterId,
                                                                           @Param("groupName") String groupName);

    int selectCountByParams(Map<String, Object> params);

    List<ConfScalingTask> selectAllByEsRuleId(Map<String, Object> params);
    ...
    List<ConfScalingTask> queryInQueueAndRunningTaskCount(ConfScalingTask scalingTask);

    int queryRunningTaskCount(ConfScalingTask scalingTask);

    ConfScalingTask queryLastOne(ConfScalingTask task);
