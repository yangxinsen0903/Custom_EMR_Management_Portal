CREATE TABLE if not exists `info_cluster_vm_index` (
    ...
    `end_index` INT COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '最大序号',
    ...
    PRIMARY KEY (`cluster_id`, `vm_role`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='集群的vm序号';