...
begin
    ...
    set var_table_name = 'info_vm_statement';
    set var_table_column = 'region';
    set column_type = 'varchar(32)';
    set comment_value = '区域,数据中心';
    set table_count = 1 ;
...
-- add index
call create_index( 'info_vm_statement', 'idx_create_time', '(created_time)' );
call create_index( 'azure_price_history', 'idx_execute_time', '(execute_time)' );
call create_index( 'azure_price_history', 'idx_vm_sku_name', '(vm_sku_name)' );
