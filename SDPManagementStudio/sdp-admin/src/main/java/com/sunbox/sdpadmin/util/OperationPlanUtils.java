...
import com.sunbox.sdpadmin.model.admin.response.GetJobQueryParamDictOutput;
...
public class OperationPlanUtils {
    ...
    public static GetJobQueryParamDictOutput getJobQueryParamDict() {
        ...
        output.getJobNames().add(new GetJobQueryParamDictOutput.KvItem("scale_out_evict_vm", "补全驱逐VM"));
