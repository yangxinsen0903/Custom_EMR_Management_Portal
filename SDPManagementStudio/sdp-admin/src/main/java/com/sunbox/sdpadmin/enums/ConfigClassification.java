package com.sunbox.sdpadmin.enums;
...
public enum ConfigClassification {
    ...
    ConfigClassification(String service, String classification, String configFile) {
     ...
     * @return
     */
    public static String parseToService(String classification) {
        for (ConfigClassification value : values()) {
    ...
    public static void main(String[] args) {
        for (ConfigClassification value : ConfigClassification.values()) {
//            if (exists(value.getClassification())) {
//                continue;
//            }
            String serviceName = value.service;
            ...
            sql.append("replace INTO sdpms.base_release_apps_config (release_version,app_name,app_config_classification,app_config_file,sort_no,is_delete,createdby,created_time) VALUES ");
            sql.append("('SDP1.0','" + serviceName + "','" + value.classification + "','" + value.configFile + "', NULL, 0, 'sysadmin', now());");
