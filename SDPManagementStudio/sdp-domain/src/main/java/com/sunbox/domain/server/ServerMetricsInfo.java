 ...
 */
package com.sunbox.domain.server;
...
public class ServerMetricsInfo {
    ...
    private void setSysInfo() {
        ...
        sys.setComputerIp(StrUtil.join(",", ips));
    ...
    public static void main(String[] args) throws Exception {
        ServerMetricsInfo serverMetricsInfo = new ServerMetricsInfo();
        serverMetricsInfo.copyTo();
        System.out.println(JSONUtil.toJsonStr(serverMetricsInfo));
    }
}
