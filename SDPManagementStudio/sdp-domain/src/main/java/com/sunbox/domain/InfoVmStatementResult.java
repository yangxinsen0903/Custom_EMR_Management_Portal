...
public class InfoVmStatementResult {
    private Long id;
    ...
    private String azureResult;
    private String sdpResult;
    private String yarnResult;
    ...
    public String getAzureResult() {
        return azureResult;
    }

    public void setAzureResult(String azureResult) {
        this.azureResult = azureResult;
    }

    public String getSdpResult() {
        return sdpResult;
    }

    public void setSdpResult(String sdpResult) {
        this.sdpResult = sdpResult;
    }

    public String getYarnResult() {
        return yarnResult;
    }

    public void setYarnResult(String yarnResult) {
        this.yarnResult = yarnResult;
    }
}
