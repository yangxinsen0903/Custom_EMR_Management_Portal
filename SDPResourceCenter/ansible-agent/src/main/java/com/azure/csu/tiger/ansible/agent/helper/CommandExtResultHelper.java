...
public class CommandExtResultHelper{

	private static final Logger logger = LoggerFactory.getLogger(CommandExtResultHelper.class);
	...
	public static Map<String, ReturnValue> parseCommandReturnValues(List<String> rawOutput) {
		/**
...
//		responses.entrySet().forEach(i -> {
//			logger.info("ip: {}, result: {}", i.getKey(), i.getValue().getResult());
//		});
		return responses;
	}
